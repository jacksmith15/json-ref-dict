...
import json_ref_dict as package
...
def repo_compare(
    ...
    return (
        ...
        f"json-ref-dict/compare/{old or 'initial'}..{new or 'HEAD'}\n"
    )
...
def github_release_body(current_version: Version, next_version: Version):
    return f"""
[Release Notes](https://github.com/jacksmith15/json-ref-dict/blob/{next_version}/CHANGELOG.md)
[Changes](http://github.com/jacksmith15/json-ref-dict/compare/{current_version}..{next_version})
"""
